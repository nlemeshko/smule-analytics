...
SELECT  p.*,
        ...
        case when pf.rating_nbr = 5 then 1 else 0 end favorite_ind,
        pf.rating_nbr,
        case when owner_handle = '_hot_dsip' and web_url not like '%ensembles' and ensemble_type != 'SOLO' then 1 else 0 end join_ind
FROM    performance p
